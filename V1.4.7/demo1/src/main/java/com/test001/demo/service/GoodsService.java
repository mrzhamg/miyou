...
public class GoodsService {
    ...
    public List<Goods> findGoodsLimit(int num){return goodsMapper.findGoodsLimit(num);};
    ...
    public void insertGoods(Goods goods){
        ...
        goodsMapper.insertGoods(goods.getSjid(),goods.getDescribe(),goods.getPrice(),goods.getImg(),goods.getClassify(),goods.getMiaoshu(),goods.getIsputaway());
    }
    ...
    public void UpdataGoodsAll(int sid,String describe, float price, String classify,Boolean isputaway, String miaoshu){
        System.out.println(sid+describe+price+classify+isputaway+miaoshu);
        goodsMapper.UpdataGoodsAll(sid,describe,price,classify,isputaway,miaoshu);
    };
    //删除商品
