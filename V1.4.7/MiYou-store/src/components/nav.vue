  ...
  <div>
    <div class="nav-box">
      ...
      >
        ...
        <el-menu-item v-if="!userdata.uid" index="/login">登录</el-menu-item>
        <el-menu-item v-if="!userdata.uid" index="/register">注册</el-menu-item>
        <el-menu-item index="/about">个人中心</el-menu-item>

        <el-menu-item v-if="userdata.isStore" index="/storehome">我是商家</el-menu-item>
        <el-menu-item v-else-if="!userdata.isStore&&userdata!=null" index="/storehome">商家注册</el-menu-item>
      </el-menu>
    </div>
  </div>
</template>
