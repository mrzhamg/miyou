    ...
    <div class="about-jbxx">
      ...
      <p class="aboutBtn">
        <el-button type="primary"
                   @click="dialogVisible2 = true">编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    // 基本信息取消按钮
    resetForm: () => {
      // console.log('取消', this.dialogVisible2)
    ...
    handleClick (row) {
      ...
      if (row) {
        ...
        this.btnBC = true
        this.btnTJ = false
        this.addressForm.aid = ''
        this.addressForm.shoujianren = ''
        this.addressForm.sjrPhone = ''
