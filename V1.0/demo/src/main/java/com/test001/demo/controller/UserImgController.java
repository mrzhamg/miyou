...
public class UserImgController {
    ...
    private Result upLoadName(@RequestParam MultipartFile file,@RequestHeader("Authorization") String t,@RequestParam("uid") int uidd) throws IOException {
//        System.out.println("token=>"+t+";uid=>"+uidd+";file=>"+file);
        //验证token
        if(token.verify(t)){
            int uid=uidd;
...
//        System.out.println("path=>"+paths);
        FileOutputStream fileOutputStream = new FileOutputStream("D:\\MiYouStore_data\\userImg\\" + uuid.toString()+ type);
