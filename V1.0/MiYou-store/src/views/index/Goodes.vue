<template>
  <div class="goodes">
    ...
    <div class="g-content">
      ...
      <div class="title">
        <div>
          <p class="shnagjia"><span class="span-g">商家id：</span>{{goods.sjid}}
            <span class="span-g">店铺名称：</span>{{goods.shangjia_user[0].sj_name}}
          </p>
          <p><span class="span-g">商品描述：</span>{{goods.describe}}</p>
          <p><span class="span-g">价格</span>：￥<span class="span-red">{{goods.price}}</span></p>
          <div class="num"><span class="span-g">数量：</span>
            <div class="numBtn">
              <input type="button"
                     @click="num==1? '1': num--"
                     value="-">
